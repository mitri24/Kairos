...
const APP_SHELL = [
  ...
  "/js/icons.js",
  "/shared/pomodoro.js",
  "/shared/daySchedule.js",
  "/shared/streak.js",
  "/shared/pace.js",
  "/shared/voiceParse.js",
  "/shared/learnOptions.js",
  "/shared/dateKey.js",
  ...
  event.waitUntil(
    (async () => {
      ...
      await self.registration.showNotification(data.title || "Kairos", {
        ...
        // Badge wird vom OS auf eine Farbe maskiert → einfarbiges PNG mit Alpha.
        badge: data.badge || "/icons/badge-128.png",
